...
# socket()	Creates a new TCP socket.
# bind()	Associates the server socket with a specific IP address and port.
# listen()	Puts the server socket into listening mode, waiting for connections.
# accept()	Accepts an incoming client connection and returns a new socket.
# recv()	Receives data from the connected client.
# send() / sendall()	Sends data back to the connected client.
